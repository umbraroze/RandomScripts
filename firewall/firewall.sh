...
ip6tables -A INPUT -p tcp -i $NETIF --dport 25 -j REJECT
# ssh
iptables -A INPUT -p tcp -i $NETIF -d $MYIP --dport 2209 -j REJECT
ip6tables -A INPUT -p tcp -i $NETIF --dport 2209 -j REJECT
# mysql
iptables -A INPUT -p tcp -i $NETIF -d $MYIP --dport 3306 -j REJECT
ip6tables -A INPUT -p tcp -i $NETIF --dport 3306 -j REJECT
# postgresql
iptables -A INPUT -p tcp -i $NETIF -d $MYIP --dport 5432 -j REJECT
ip6tables -A INPUT -p tcp -i $NETIF --dport 5432 -j REJECT
# X11 just in case
iptables -A INPUT -p tcp -i $NETIF -d $MYIP --dport 6000:6100 -j REJECT
ip6tables -A INPUT -p tcp -i $NETIF --dport 6000:6100 -j REJECT
